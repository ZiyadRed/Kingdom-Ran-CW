...
const GUIDE_COPY = {
  ja: {
    ...
    statsScreen: {
      ...
      markers: {
        '1': { title: 'HP', body: '同盟争覇戦での最大HP。' },
        '2': { title: '士気', body: '最大士気。士気技能はこの上限を基準にします。' },
        '3': { title: '最大攻撃', body: 'ダメージ計算に使われる攻撃値の上限。' },
        '4': { title: '最小攻撃', body: 'ダメージ計算に使われる攻撃値の下限。' },
        ...
        '8': { title: '会心率', body: '攻撃が会心になる確率。' },
        '9': { title: '会心ダメージ', body: '会心が発生したときに加わる追加ダメージ。' },
        '10': { title: '防御貫通', body: '敵の防御の一部を無視しやすくします。攻撃とは別の値です。' },
        '11': { title: '防御', body: '受けるダメージを減らします。' },
    ...
    crystals: {
      intro: '4種類の結晶で技能を解放できますが、互換性はありません。それぞれ決められた用途にだけ使えます。',
      items: {
        red: { name: '赤水晶', unlocks: '同盟争覇戦技能', body: '標準的な結晶です。すべての武将の同盟争覇戦技能3つを解放します。', cost: 'UR武将を完全解放するには1,750個（技能ごとに100 / 550 / 1,100）。SRは800個、Rは595個です。' },
