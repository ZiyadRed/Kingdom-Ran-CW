...
const GUIDE_COPY = {
  ja: {
    ...
    crystals: {
      intro: '4種類の争覇解放石で技能を解放できますが、互換性はありません。それぞれ決められた用途にだけ使えます。',
      items: {
        red: { name: '赤の争覇解放石', unlocks: '同盟争覇戦技能', body: '標準的な争覇解放石です。すべての武将の同盟争覇戦技能3つを解放します。', cost: 'UR武将を完全解放するには1,750個（技能ごとに100 / 550 / 1,100）。SRは800個、Rは595個です。' },
        blue: { name: '青の争覇解放石', unlocks: '飛信隊専用', body: '赤の争覇解放石と同じように使えますが、飛信隊の武将にだけ使用できます。', cost: '赤の争覇解放石と同じコストです。先に飛信隊の武将へ使い、赤の争覇解放石を他の武将用に残します。' },
        orange: { name: '橙の争覇解放石', unlocks: '総大将スキル', body: 'その役割を担当できる武将の総大将スキルを解放します。', cost: '武将1人につき1,000個。' },
        green: { name: '緑の争覇解放石', unlocks: '軍師技能', body: 'その役割を担当できる武将の軍師技能を解放します。', cost: '武将1人につき1,000個。' },
      },
      spendTitle: '先に使う争覇解放石',
      spendItems: [
        '青の争覇解放石は用途が最も限られるため、赤の争覇解放石を使う前に飛信隊の武将へ使います。',
        '赤の争覇解放石は常に不足しやすく、UR武将1人だけでも1,750個必要です。',
        '橙の争覇解放石と緑の争覇解放石は、総大将または軍師役を担当できる武将を得てから重要になります。詳しくは「総大将・軍師」を確認してください。',
      ],
    },
    leaders: {
      intro: '任意で解放できる2つの技能です。どちらも1ターン目に発動し、所持者が倒されると不利な結果になります。',
      roles: {
        leader: { label: '総大将', stone: '橙の争覇解放石', riskLabel: '総大将が倒れた場合', risk: '他の武将が生存していても、その場で敗北します。' },
        strategist: { label: '軍師', stone: '緑の争覇解放石', riskLabel: '軍師が倒れた場合', risk: '味方全員が1ターンの間、錯乱になります。' },
      },
      unlock: '解放：',
      generalsLabel: '武将',
      howTitle: '仕組み',
