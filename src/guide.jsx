  ...
  ja: {
    ...
    statsScreen: {
      ...
      markers: {
        ...
        '2': { title: '士気', body: '最大士気。士気スキルはこの上限を基準にします。' },
    ...
    stats: {
      intro: '同盟争覇戦ステータスは、バフ以外にも複数の育成要素の影響を受けます。最終値は武将、兵士、武器、そして少量の追想カードボーナスによっても変わります。',
      ...
      affectsItems: [
        ...
        '兵士レベル。',
        '武器レベルと武器レアリティ。',
        '武将の追想カード。やり込み向けに少量のステータス上昇を与えます。',
      ],
    },
    roles: {
    ...
    debuffs: {
      intro: 'デバフ耐性は、特定の不利な効果が適用される前にその強さを減らします。攻撃力低下、防御力低下、防御力貫通が実際に命中するかを判断するときに重要です。',
      coversTitle: '耐性の対象',
      coversItems: [
    ...
    terrain: {
      intro: '地形効果は、城と城の間の侵攻経路に付く同盟争覇戦マップ上のデバフです。与えるダメージを下げる、受けるダメージを増やす、または開始時体力を減らすことがあります。',
      noTerrain: '地形なし',
      items: {
        ...
        checkpoint: { name: '関所', effect: '開始時体力 -30%', detail: '関所の経路から侵攻すると、攻撃側の部隊は体力30%減少の状態で戦闘を開始します。', mitigatedBy: '斥候でこの開始時体力減少を軽減できます。' },
        ambush: { name: '伏兵', effect: '開始時体力 -30%', detail: '伏兵の経路から侵攻すると、攻撃側の部隊は体力30%減少の状態で戦闘を開始します。', mitigatedBy: '部隊保護でこの開始時体力減少を軽減できます。' },
      },
    ...
    crystals: {
      intro: '4種類の解放アイテムでスキルを解放できますが、互換性はありません。それぞれ決められた用途にだけ使えます。',
      items: {
        red: { name: '赤の結晶', unlocks: '同盟争覇戦スキル', body: 'すべての武将の同盟争覇戦スキル3つを解放する結晶です。', cost: 'UR武将を完全解放するには1,750個（スキルごとに100 / 550 / 1,100）。SRは800個、Rは595個です。' },
        blue: { name: '専用争覇解放石(飛信隊)', unlocks: '飛信隊専用', body: '赤の結晶と同じように使えますが、飛信隊の武将にだけ使用できます。', cost: '赤の結晶と同じコストです。先に飛信隊の武将へ使い、赤の結晶を他の武将用に残します。' },
        orange: { name: '争覇総大将解放石', unlocks: '争覇総大将スキル', body: 'その役割を担当できる武将の争覇総大将スキルを解放します。', cost: '武将1人につき1,000個。' },
        green: { name: '争覇軍師解放石', unlocks: '争覇軍師スキル', body: 'その役割を担当できる武将の争覇軍師スキルを解放します。', cost: '武将1人につき1,000個。' },
      },
      spendTitle: '先に使う解放アイテム',
      spendItems: [
        '専用争覇解放石(飛信隊)は用途が最も限られるため、赤の結晶を使う前に飛信隊の武将へ使います。',
        '赤の結晶は常に不足しやすく、UR武将1人だけでも1,750個必要です。',
        '争覇総大将解放石と争覇軍師解放石は、総大将または軍師役を担当できる武将を得てから重要になります。詳しくは「争覇総大将・争覇軍師」を確認してください。',
      ],
    },
    leaders: {
      intro: '任意で解放できる2つの役割スキルです。どちらも1ターン目に発動し、所持者が倒されると不利な結果になります。',
      roles: {
        leader: { label: '総大将', stone: '争覇総大将解放石', riskLabel: '総大将が倒れた場合', risk: '他の武将が生存していても、その場で敗北します。' },
        strategist: { label: '軍師', stone: '争覇軍師解放石', riskLabel: '軍師が倒れた場合', risk: '味方全部隊に「混乱」が1ターン付与されます。' },
      },
      unlock: '解放：',
      generalsLabel: '武将',
      howTitle: '仕組み',
      howItems: [
        '役割を持つ武将が編成に設定されると、スキルは1ターン目に発動します。',
        '1編成につき総大将1人と軍師1人です。両方を同時に使えますが、それぞれ1人だけです。',
        '効果は武将ごとに異なるため、枠を埋めることと同じくらい、どの武将に担当させるかが重要です。',
        '2つのペナルティは同じではありません。軍師を失うと味方全部隊に「混乱」が1ターン付与され、総大将を失うと敗北するため、総大将枠には狙われにくい武将を置きます。',
      ],
    },
    interactions: {
    ...
    targeting: {
      intro: 'スキルが対象を選ぶ方法と、状態異常が対象選択に与える影響です。',
      rules: {
        'Skill Target Selection Priority': { title: 'スキル対象の選択優先度', body: '対象に特殊な状態異常がある場合、対象選択は次の順に従います。', list: ['状態異常の有無（例：挑発、錯乱）', 'スキルに指定された優先条件（例：攻撃力が最も高い、または防御力が最も低い）'] },
        'Unmet Target Conditions': { title: '対象条件を満たさない場合', body: 'スキルが指定した対象が戦場に存在しない場合（例：秦の武将がいないのに「敵秦武将」を指定した場合）、効果は発動しません。' },
        'Random Targeting': { title: 'ランダム対象', body: '「ランダムな敵武将」を対象にするスキルは、制限なしでランダムに選び、挑発を無視します。' },
        Provocation: { title: '挑発', bullets: ['敵の攻撃ダメージを挑発中の武将に集中させます。', 'ダメージを与えないスキルの対象選択には影響しません。', '重複せず、再付与すると既存の状態を上書きします。'] },
        Confusion: { title: '錯乱', bullets: ['効果中の武将は味方と敵を区別せず攻撃します。', 'スキルが使える場合はスキルを使い、使えない場合は通常攻撃を行います。', '生存している味方がいなくなった場合は、通常どおり敵を攻撃します。', '重複せず、再付与すると残り時間が長い方に更新されます。', '裏切りまたは暴走中の武将には付与できません（それらが優先されます）。一方、錯乱中の武将に裏切りまたは暴走を付与すると、錯乱が上書きされます。'] },
      },
    },
    effects: {
      ...
      debuffsTitle: 'デバフ',
      items: {
        'Less Likely to be Targeted': { name: '敵武将から狙われにくい', description: '敵の通常攻撃とスキル攻撃の対象から除外されます。' },
        ...
        'Severe Poison': { name: '猛毒', description: '各ターンの開始時、最大体力の割合分のダメージを受けます（毒より強力です）。' },
        Burn: { name: '火傷', description: '各ターンの開始時、最大体力の割合分のダメージを受けます。' },
        Illusion: { name: '幻影', description: '命中率を下げます。' },
        Paralysis: { name: '麻痺', description: '毎ターン、行動（通常攻撃とスキル攻撃）を封じる可能性があります。' },
        ...
        'Attack Seal': { name: '封印', description: '指定された行動を無効にします。通常攻撃封印、スキル攻撃封印、攻撃封印（両方）があります。' },
    ...
    types: {
      intro: '通常スキルは3つのカテゴリに分かれます。条件を満たす武将は、編成役割のスキルを2種類のうち1つ解放できます。',
      items: {
        '戦技': { label: '戦技', description: '戦闘中に使うアクティブスキルです。ダメージ、バフ・デバフの付与、回復などを行います。' },
        '軍略': { label: '軍略', description: '部隊に継続的なバフや条件付き効果を与える、パッシブ型のスキルです。' },
        '内政': { label: '内政', description: '同盟全体のステータスを上げる非戦闘スキルです。武将を出撃させていないときも有効です。' },
        '総大将スキル': { label: '争覇総大将スキル', description: '任意で設定できる1ターン目の役割スキルです。1編成につき総大将は1人だけで、失うと戦闘に敗北します。' },
        '軍師スキル': { label: '争覇軍師スキル', description: '任意で設定できる1ターン目の役割スキルです。1編成につき軍師は1人だけで、戦闘不能になると味方全部隊に「混乱」が1ターン付与されます。' },
      },
    },
  },
  ar: {
