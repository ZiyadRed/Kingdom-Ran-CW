...
export const ROUTE_MODULES = {
  archive: { source: 'src/ArchiveHubPage.jsx', load: () => import('./ArchiveHubPage.jsx') },
...
export function selectedRouteSource(canonicalPath) {
  if (canonicalPath === '/archive') return ROUTE_MODULES.archive.source
  ...
  if (canonicalPath.startsWith('/archive/') || ['/builder', '/sim', '/tiers', '/cost'].includes(canonicalPath)) return ROUTE_MODULES.pages.source
