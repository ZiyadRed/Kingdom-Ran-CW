...
export const STATS = {
  ...
  'Provoke Infliction Rate': '「挑発」付与確率',
  'Poison Infliction Rate': '「毒」付与確率',
  'Burn Infliction Rate': '「火傷」付与確率',
  'Illusion Infliction Rate': '「幻影」付与確率',
  'Paralysis Infliction Rate': '「麻痺」付与確率',
  'Confusion Infliction Rate': '「錯乱」付与確率',
  'Betrayal Infliction Rate': '「裏切り」付与確率',
  'Rampage Infliction Rate': '「暴走」付与確率',
