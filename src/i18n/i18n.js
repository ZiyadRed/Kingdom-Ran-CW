...
const en = {
 ...
 sections: 'Archive sections', title: 'Archive', sceneSubtitle: '6★ scene-card skills and owners', ownershipFilter: 'CW6 ownership filter', searchGenerals: 'Search generals', roster: '{{faction}} Roster', skills: 'Skills', skillsAndStats: 'Skills, stats, and factions', sceneCards: 'CW6★ Scene Cards', cardArt: 'Scene card art', owners: 'Owners' },
  builder: { title: 'Party Builder', subtitle: 'Click slots to add generals. Generals act in formation order.', formationSide: 'Formation side', attacking: 'Attacking', defending: 'Defending', clickAdd: 'Click to add', viewBattleOrder: 'View Battle Order', teamBuffs: 'Team buffs', calculated: 'Calculated from this formation', hide: 'Hide', review: 'Review', knownTeam: 'Start from a known team', knownTeamDescription: 'Load a current formation, then adjust it in the editor above.', sharedPlanInvalid: 'This shared formation could not be loaded. Start a new formation or ask the sender for a new link.' },
  sim: { title: 'Battle Order', description: 'Selected Leader and Strategist role skills use fixed turn-1 priority before each side’s first general. Normal general actions remain in formation order, with combat skills using the highest skill slot first.', editTeams: 'Edit teams', chooseTeams: 'Choose both attacking and defending teams first.', emptyDescription: 'Battle Order turns your completed attacking and defending teams into a clear skill activation sequence.', emptyReason: 'There is nothing to display yet because one or both teams are incomplete.', goBuilder: 'Go to Party Builder', strategySkills: 'Start-of-battle Strategy skills — reference', activation: 'Tracked Battle Order', openingRule: 'Turn 1 role priority is fixed: Leader first, then Strategist, then the side’s first general — regardless of formation position.', roleConditional: 'Activation priority only: a role skill fires only when it is unlocked, its holder is assigned that role, and enough morale is available.', timelineLimit: 'Strategy effects are listed as reference below; mass-army and weapon actions are not tracked in this timeline.', specialRoleAction: 'Special role skill — if activated', attackingSide: 'Attacking side', defendingSide: 'Defending side', turn: 'Turn {{turn}}' },
  guide: {
...
const ar = {
 ...
 sections: 'أقسام الأرشيف', title: 'الأرشيف', sceneSubtitle: 'مهارات بطاقات المشهد 6★ ومالكوها', ownershipFilter: 'مرشح ملكية CW6', searchGenerals: 'ابحث عن الجنرالات', roster: 'قائمة {{faction}}', skills: 'المهارات', skillsAndStats: 'المهارات والخصائص والفصائل', sceneCards: 'بطاقات CW6★', cardArt: 'صورة بطاقة المشهد', owners: 'المالكون' },
  builder: { title: 'منشئ الفرق', subtitle: 'انقر على الخانات لإضافة الجنرالات. يتحرك الجنرالات حسب ترتيب التشكيلة.', formationSide: 'جانب التشكيلة', attacking: 'الهجوم', defending: 'الدفاع', clickAdd: 'انقر للإضافة', viewBattleOrder: 'عرض ترتيب الجولات', teamBuffs: 'تعزيزات الفريق', calculated: 'محسوبة من هذه التشكيلة', hide: 'إخفاء', review: 'مراجعة', knownTeam: 'ابدأ من فريق معروف', knownTeamDescription: 'حمّل تشكيلة حالية ثم عدّلها في المحرر أعلاه.', sharedPlanInvalid: 'تعذّر تحميل التشكيلة المشتركة. أنشئ تشكيلة جديدة أو اطلب رابطًا جديدًا من المرسل.' },
  sim: { title: 'ترتيب الجولات', description: 'تُدرج مهارات الدور المختارة للقائد والاستراتيجي بأولوية ثابتة في الجولة الأولى قبل أول جنرال من كل جانب. وتبقى تحركات الجنرالات العادية حسب ترتيب التشكيلة، مع إطلاق المهارات القتالية بدءًا من الخانة ذات الرقم الأعلى.', editTeams: 'تعديل الفرق', chooseTeams: 'اختر فريق الهجوم والدفاع أولًا.', emptyDescription: 'يحوّل ترتيب الجولات فريقي الهجوم والدفاع المكتملين إلى تسلسل واضح لإطلاق المهارات.', emptyReason: 'لا يوجد ما يُعرض بعد لأن فريق الهجوم أو الدفاع غير مكتمل.', goBuilder: 'الانتقال إلى منشئ الفرق', strategySkills: 'مهارات الاستراتيجية عند بدء المعركة — مرجع', activation: 'ترتيب المعركة المتتبّع', openingRule: 'أولوية الأدوار في الجولة الأولى ثابتة مهما كان ترتيب التشكيلة: القائد أولًا، ثم الاستراتيجي، ثم أول جنرال من الجانب.', roleConditional: 'هذه أولوية تفعيل فقط؛ لا تُطلق مهارة الدور إلا إذا كانت مفتوحة، وعُيّن حاملها في ذلك الدور، وتوفرت المعنويات الكافية.', timelineLimit: 'تُعرض تأثيرات الاستراتيجية أدناه كمرجع؛ أما تأثيرات الجيش الكبير وهجمات الأسلحة فلا يتتبعهما هذا التسلسل.', specialRoleAction: 'مهارة دور خاصة — إذا تحققت شروط التفعيل', attackingSide: 'جهة الهجوم', defendingSide: 'جهة الدفاع', turn: 'الجولة {{turn}}' },
  guide: {
...
const fr = {
  ...
  builder: {
    title: 'Créateur d’équipe', subtitle: 'Cliquez sur un emplacement pour ajouter un général. Les généraux agissent dans l’ordre de la formation.', formationSide: 'Type de formation', attacking: 'Attaque', defending: 'Défense', clickAdd: 'Cliquez pour ajouter', viewBattleOrder: 'Voir l’ordre d’activation', teamBuffs: 'Buffs d’équipe', calculated: 'Calculés à partir de cette formation', hide: 'Masquer', review: 'Voir', knownTeam: 'Partir d’une composition connue', knownTeamDescription: 'Chargez une formation du moment, puis ajustez-la dans l’éditeur ci-dessus.', mixedCountry: 'Mixte', sharedPlanInvalid: 'Impossible de charger l’équipe partagée. Créez une nouvelle équipe ou demandez un nouveau lien à l’expéditeur.',
  },
  sim: {
    title: 'Ordre d’activation', description: 'Les compétences de rôle sélectionnées du Leader et du Stratège suivent une priorité fixe au tour 1, avant le premier général de chaque camp. Les actions normales restent dans l’ordre de la formation, et les compétences de combat partent de l’emplacement au numéro le plus élevé.', editTeams: 'Modifier les équipes', chooseTeams: 'Choisissez d’abord une équipe d’attaque et une équipe de défense.', emptyDescription: 'L’ordre d’activation présente les compétences de vos équipes d’attaque et de défense dans leur ordre de déclenchement.', emptyReason: 'Rien à afficher pour l’instant : au moins une des deux équipes est incomplète.', goBuilder: 'Aller au créateur d’équipe', strategySkills: 'Compétences de stratégie au début du combat — référence', activation: 'Ordre de combat suivi', openingRule: 'Au tour 1, la priorité des rôles est fixe : Leader, puis Stratège, puis premier général du camp, quel que soit leur emplacement dans la formation.', roleConditional: 'Il s’agit uniquement de la priorité : la compétence de rôle ne se déclenche que si elle est débloquée, si son détenteur occupe ce rôle et si le moral est suffisant.', timelineLimit: 'Les effets de stratégie sont présentés ci-dessous à titre de référence ; les effets de grande armée et les attaques d’armes ne sont pas suivis ici.', specialRoleAction: 'Compétence de rôle spéciale — si elle se déclenche', attackingSide: 'Camp attaquant', defendingSide: 'Camp défenseur', turn: 'Tour {{turn}}',
  },
  guide: {
...
fr.buffs.unsupportedOmitted = 'effets non pris en charge omis des totaux'
...
ja.stats.autoSave = '自動保存'
ar.saveFailedBrowser = 'لم يتم الحفظ — مساحة تخزين المتصفح غير متاحة'
ar.stats.saveFailed = 'لم يتم الحفظ — مساحة تخزين المتصفح غير متاحة'
ar.browserStorage = 'تخزين المتصفح'
ar.stats.autoSave = 'حفظ تلقائي'
fr.saveFailedBrowser = 'Non enregistré — le stockage du navigateur est indisponible'
fr.stats.saveFailed = 'Non enregistré — le stockage du navigateur est indisponible'
