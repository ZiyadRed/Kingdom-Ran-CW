...
const ja = {
  ...
  archive: { sections: 'アーカイブのセクション', title: 'アーカイブ', sceneSubtitle: '☆6争覇カード技能と所持者', ownershipFilter: 'CW6所持フィルター', searchGenerals: '武将を検索', roster: '{{faction}}の武将', skills: '技能', skillsAndStats: '技能・ステータス・勢力', sceneCards: 'CW6★争覇カード', cardArt: '争覇カード画像', owners: '所持者' },
  ...
  guide: { title: '同盟争覇戦攻略', intro: '同盟争覇戦のルール、対象、状態異常、地形、相性をまとめています。', section: '攻略セクション', contents: '攻略目次', beginner: '初級', advanced: '上級', basics: '基本', roles: '武将の役割', stats: '争覇ステータス', glossary: '用語集', sections: { basics: '基本', 'stats-screen': '争覇ステータス画面', roles: '役割', bandits: '盗賊討伐', matchups: '兵種相性', types: '技能タイプ', crystals: '水晶の種類', stats: '争覇ステータスの上げ方', leaders: '総大将・軍師', debuffs: 'デバフ耐性', effects: '状態異常', terrain: '地形効果', interactions: '効果の相互作用', targeting: '対象選択ルール' } },
  noChange: '変化なし', vsCurrent: '現在との差', minimumAttack: '最小攻撃', maximumAttack: '最大攻撃', defense: '防御', added: '追加済み', full: '満員', costLabel: 'コスト', redCrystalAlt: '赤水晶', efficiencyTooltip: '効率：{{value}}赤水晶／バフ1%。低いほど有利（コスト{{cost}}／バフ{{buff}}%）', redCrystalCostTooltip: '赤水晶の技能解放コスト：{{cost}}',
  stats: { title: 'ステータス計算', description: '争覇画面の数値と有効なバフを入力します。割合バフや争覇カードの基礎バフを加えて戦力を確認できます。', saved: '自動保存', reset: '計算をリセット', confirmClear: 'この端末に保存した計算編成と武将数値をすべて削除しますか？', addTeam: '編成を追加', maxTeams: '編成は最大5つです', addCharacter: '武将を追加', searchHint: '入力して空いている枠に武将を追加します。', fullHint: '4枠すべて使用中です。カードの武将変更から入れ替えられます。', noCharacterMatches: '「{{query}}」に一致する武将はいません。', team: '編成 {{number}}', removeTeam: '編成を削除', powerAfterBuffs: 'バフ適用後の争覇戦力', screenValues: '争覇画面の数値', fromScreen: '争覇画面から', activeBuffs: '適用中のバフ', buffsToAdd: '追加するバフ', sceneCardBuffs: '争覇カード基礎バフ', changeCharacter: '武将を変更', editHint: '上の武将を選択して数値を編集します。', chooseCharacter: '武将を選択', hp: 'HP', attack: '攻撃', defense: '防御' },
  noBoard: 'ボードなし', buffType: 'バフ種別', unitType: '兵種', state: '勢力', meta: { title: '争覇メタウォッチ', subtitle: 'よく見られる編成 · 最終更新：2026年6月', by: 'ティアリスト作成：', apex: '頂点 — ゲーム最強の編成', kings: '★ 圧倒的メタキング ★', source: '出典：対戦記録、X、YouTube、コミュニティ情報 · 基準：編成相性・固有技能・兵種ステータス・育成コスト', tier: 'ティア {{tier}}' }, teamCost: { title: '編成コスト', description: '4人までの武将を育成するために必要な赤水晶を計算します。', needed: '必要な赤水晶', chooseSlot: '枠を選択して開始', clearAll: 'すべてクリア', team: '編成', selected: '{{count}} / 4 選択中', skills: '技能コスト', byRarity: 'レアリティ別', rarity: 'レアリティ', skill: '技能{{number}}', total: '合計', selectGeneral: '武将を選択', slot: '枠{{number}}', search: '検索…', clickAdd: 'クリックして武将を追加', maxed: '最大', change: '変更', buffs: { title: 'バフ管理', description: '所持している常時バフを記録し、兵種・状態・特殊部隊・地形・争覇カードの合計を確認します。', find: 'カテゴリまたは武将を検索', search: 'バフを検索…', redCrystal: '赤水晶強化', shard: '欠片強化（+5%）', unitTypes: '兵種', states: '勢力', specialUnits: '特殊部隊', terrain: '地形', sceneCards: '争覇カード', sceneDescription: '争覇カードのバフはすべての武将に適用されます。', ownedTotals: '所持バフ合計', sourcesOwned: '{{owned}}/{{total}}件を所持として記録', showTotals: 'カテゴリ別の合計を表示', byCategory: 'カテゴリ別・クリックで展開', noCards: 'このフィルターにカードはありません。', tapCategory: '上のカテゴリをタップすると争覇バフを確認できます', buffsOwned: '争覇カードバフ {{owned}}/{{total}}件を所持', ownershipFilter: '争覇カードバフ所持フィルター' }, castlePoints: { tool: '同盟争覇戦ツール', title: '城ポイント', mode: '同盟争覇戦モード', pointSummary: 'ポイント値と現在の概要', large: '大城', medium: '中城', small: '小城', largeShort: '大', mediumShort: '中', smallShort: '小', castle: '城', alliance: '同盟', today: '本日', currentTotal: '現在合計', projected: '予測', board: '同盟ボード', reset: 'リセット', addAlliance: '同盟を追加', add: '追加', ranking: '予測順位', pointsToday: '本日 {{count}}ポイント', mine: '自分', remove: '削除', allianceName: '同盟名', currentPoints: '累計ポイント', bottomTwo: '下位2同盟', projectedFirst: '予測1位', leading: 'このボードでは自同盟が首位です。', behindFirst: '1位まで {{count}}ポイント', roughly: 'およそ{{count}}。', allianceCount: '{{count}}同盟', allianceCount_one: '{{count}}同盟', castleCount: '{{count}}城', castleCount_one: '{{count}}城', largeCastleCount: '{{count}}大城', largeCastleCount_one: '{{count}}大城', mediumCastleCount: '{{count}}中城', mediumCastleCount_one: '{{count}}中城', smallCastleCount: '{{count}}小城', smallCastleCount_one: '{{count}}小城', zeroPoints: '0ポイント', versionOne: 'バージョン1.0', versionTwo: 'バージョン2.0' },
  },
