...
const fr = {
  ...
  builder: {
    title: 'Créateur d’équipe', subtitle: 'Cliquez sur un emplacement pour ajouter un général. Les compétences se déclenchent en commençant par le dernier emplacement.', formationSide: 'Type de formation', attacking: 'Attaque', defending: 'Défense', clickAdd: 'Cliquez pour ajouter', viewBattleOrder: 'Voir l’ordre d’activation', teamBuffs: 'Buffs d’équipe', calculated: 'Calculés à partir de cette formation', hide: 'Masquer', review: 'Voir', knownTeam: 'Partir d’une composition connue', knownTeamDescription: 'Chargez une formation du moment, puis ajustez-la dans l’éditeur ci-dessus.', mixedCountry: 'Mixte',
  },
  sim: {
    title: 'Ordre d’activation', description: 'Les compétences de Leader et de Stratège se déclenchent au tour 1. Les effets de stratégie restent actifs pendant toute la bataille. Les compétences de combat se déclenchent en commençant par le dernier emplacement de la formation.', editTeams: 'Modifier les équipes', chooseTeams: 'Choisissez d’abord une équipe d’attaque et une équipe de défense.', emptyDescription: 'L’ordre d’activation présente les compétences de vos équipes d’attaque et de défense dans leur ordre de déclenchement.', emptyReason: 'Rien à afficher pour l’instant : au moins une des deux équipes est incomplète.', goBuilder: 'Aller au créateur d’équipe', leaderSkills: 'Compétences de Leader et de Stratège — tour 1', strategySkills: 'Compétences de stratégie — toujours actives', activation: 'Ordre d’activation des compétences', turn: 'Tour {{turn}}',
  },
  guide: {
