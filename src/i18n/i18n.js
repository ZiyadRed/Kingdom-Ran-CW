...
const ja = {
 ...
 sections: 'アーカイブのセクション', title: 'アーカイブ', sceneSubtitle: '☆6追想カード技能と所持者', ownershipFilter: 'CW6所持フィルター', searchGenerals: '武将を検索', roster: '{{faction}}の武将', skills: '技能', skillsAndStats: '技能・ステータス・勢力', sceneCards: 'CW6★追想カード', cardArt: '追想カード画像', owners: '所持者' },
  ...
  sim: { title: '発動順', description: '選択した争覇総大将・争覇軍師スキルは、各陣営の1人目の武将より先に、1ターン目の固定優先順で配置されます。通常の武将行動は編成順で、戦技はスキル番号の大きいものから発動します。', editTeams: '編成を編集', chooseTeams: '攻撃側と防御側の両方を先に選択してください。', emptyDescription: '発動順では、作成した攻撃・防御編成を技能の発動順に整理して確認できます。', emptyReason: '攻撃側または防御側の編成が未完成のため、まだ表示できる発動順がありません。', goBuilder: '編成作成へ', strategySkills: '戦闘開始時の軍略スキル — 参照', activation: '表示対象の発動順', openingRule: '1ターン目の役割優先順は、編成位置にかかわらず、争覇総大将、争覇軍師、各陣営の1人目の武将の順で固定です。', roleConditional: 'これは発動優先順です。役割スキルは、解放済みの武将が該当役割に設定され、必要な士気が足りる場合にのみ発動します。', timelineLimit: '軍略効果は下に参照表示しています。大軍効果と兵器の行動は、この発動順では追跡していません。', specialRoleAction: '特別な役割スキル — 条件を満たす場合', turn: '{{turn}}ターン目' },
  guide: {
