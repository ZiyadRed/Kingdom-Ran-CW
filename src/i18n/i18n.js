...
const ja = {
  ...
  guide: { title: '同盟争覇戦攻略', intro: '同盟争覇戦のルール、対象、状態異常、地形、相性をまとめています。', section: '攻略セクション', contents: '攻略目次', beginner: '初級', advanced: '上級', basics: '基本', roles: '武将の役割', stats: '争覇ステータス', glossary: '用語集', sections: { basics: '基本', 'stats-screen': '争覇ステータス画面', roles: '役割', bandits: '盗賊討伐', matchups: '兵種相性', types: '技能タイプ', crystals: '結晶タイプ', stats: '争覇ステータスの上げ方', leaders: '総大将・軍師', debuffs: 'デバフ耐性', effects: '状態異常', terrain: '地形効果', interactions: '効果の相互作用', targeting: '対象選択ルール' } },
