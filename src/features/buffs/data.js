...
export const TERRAIN_BUFFS = [
  {
    ...
    entries:[
      {ownership_id:'buff_56336c6d677c4dbd90aabe5616060232', name:'Maki', name_jp:'麻鬼', faction:'wei', type:'N', value:5.4},
      ...
      {ownership_id:'buff_bbc3356197e04374be2d3792bd3cc108', name:'Rinbou', name_jp:'鱗坊', faction:'qin', type:'R', value:14.5},
      {ownership_id:'buff_5d3fccf49e90472ab7afd5f576e83399', name:'Domon', name_jp:'土門', faction:'qin', type:'SR', value:16.6},
    ],
  },
  {
    ...
    entries:[
      {ownership_id:'buff_71b0a47da3d54ea6bd3d33cd55d095aa', name:'Douken', name_jp:'道剣', faction:'qin', type:'N', value:5.4},
      {ownership_id:'buff_8c546c2bf89945bd8e8142a9fcc2d0ac', name:'Bikou', name_jp:'尾到', faction:'qin', type:'R', value:6.3},
      {ownership_id:'buff_f9f4c302426041808bcc8d96e8afe8db', name:'Kyomei', name_jp:'羌明', faction:'qin', type:'SR', value:7.2},
      {ownership_id:'buff_d95c3363b660436c85cce54956f33e1c', name:'Heki', name_jp:'壁', faction:'qin', type:'R', value:14.5},
  ...
  },
  {
    ...
    entries:[
      {ownership_id:'buff_b36f965a0caf4121a215c19e04ec2e6f', name:'Kei', name_jp:'慶', faction:'qin', type:'N', value:5.4},
      {ownership_id:'buff_7b96f475392d459cbc108fecef81f278', name:'En', name_jp:'渕', faction:'qin', type:'R', value:6.3},
      {ownership_id:'buff_f56eacea6c7e4b8c931ed06ca6cbbf1f', name:'Kyoushou', name_jp:'羌象', faction:'qin', type:'SR', value:7.2},
      {ownership_id:'buff_17947b4e37d4456689126f6287bacfdd', name:'Doukin', name_jp:'同金', faction:'qin', type:'R', value:14.5},
  ...
  },
  {
    ...
    entries:[
      {ownership_id:'buff_77fdd51ed19e46ce88e2cd4637f1384a', name:'Kou', name_jp:'昂', faction:'qin', type:'N', value:5.4},
      {ownership_id:'buff_afe75cbc632942d19fcf6bd01d39eb08', name:'Jokan', name_jp:'徐完', faction:'qin', type:'R', value:6.3},
      {ownership_id:'buff_62464f8598f14af09b99589f9b095937', name:'Yuuren', name_jp:'幽連', faction:'wei', type:'SR', value:7.2},
      {ownership_id:'buff_91ecedaa42ac4cc6848e7c7893407028', name:'Saji', name_jp:'左慈', faction:'qin', type:'R', value:14.5},
      {ownership_id:'buff_9415bde0f1c84794ae9149621245efbe', name:'Mangoku', name_jp:'万極', faction:'zhao', type:'SR', value:16.6},
    ],
  },
  {
    ...
    entries:[
      {ownership_id:'buff_038247295e4541febf97a44f8cdf6084', name:'Gii', name_jp:'魏興', faction:'qin', type:'N', value:2.0},
      {ownership_id:'buff_021a1ef1eb6b41179f6d88b6e4a830ec', name:'Seki', name_jp:'石', faction:'qin', type:'R', value:2.4},
      {ownership_id:'buff_091f59ba04a44d3ea53a9c68c271e912', name:'Chousou', name_jp:'趙荘', faction:'zhao', type:'SR', value:2.7},
      {ownership_id:'buff_35b39a2a83db45118252390c1d4db6c5', name:'Douken', name_jp:'道剣', faction:'qin', type:'N', value:4.6},
      {ownership_id:'buff_4e6dbf901e5d497c8bb6406b0eaa3f50', name:'Ryuukoku', name_jp:'隆国', faction:'qin', type:'R', value:5.5},
      {ownership_id:'buff_1ab3a844f35747bbafee67f7a32145d5', name:'Kaishibou', name_jp:'介子坊', faction:'wei', type:'SR', value:6.2},
      {ownership_id:'buff_e62e71d858a442849172e166eb5207fa', name:'Ka', name_jp:'太子嘉', faction:'zhao', type:'UR', value:7.8},
    ],
  },
  {
    ...
    entries:[
      {ownership_id:'buff_3c7f448141984d2fb1d0de1640249818', name:'Shuki', name_jp:'朱鬼', faction:'wei', type:'N', value:2.0},
      ...
      {ownership_id:'buff_7b57d2f725ef4dfca02648329230f872', name:'Gii', name_jp:'魏興', faction:'qin', type:'N', value:4.6},
      {ownership_id:'buff_392b3952a8e547c2b3fdbb49442742be', name:'Kyougai', name_jp:'去亥', faction:'qin', type:'R', value:5.5},
      {ownership_id:'buff_fcb4231404ff49718ad5e68ecdefae88', name:'Jiou', name_jp:'江彰', faction:'zhao', type:'R', value:5.5},
      {ownership_id:'buff_38317cfa80d94b46b8b80d10d43d5ee9', name:'Rankai', name_jp:'ランカイ', faction:'mountain_folk', type:'SR', value:6.2},
    ],
  },
]
